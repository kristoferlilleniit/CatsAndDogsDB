...
namespace CatsAndDogsDB {
    ...
    public partial class PetsDataSet : global::System.Data.DataSet {
        ...
        public partial class PetTypeDataTable : global::System.Data.TypedTableBase<PetTypeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PetTypeRow AddPetTypeRow(string PetType) {
            ...
            private void InitClass() {
                ...
                this.columnPetType.MaxLength = 55;
            }
        ...
        public partial class PetTypeRow : global::System.Data.DataRow {
            ...
            public string PetType {
                get {
                    return ((string)(this[this.tablePetType.PetTypeColumn]));
                }
                set {
                    this[this.tablePetType.PetTypeColumn] = value;
                }
            }
...
namespace CatsAndDogsDB.PetsDataSetTableAdapters {
    ...
    public partial class PetTypeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PetType] WHERE (([Id] = @Original_Id) AND ([PetType] = @Origin" +
                "al_PetType))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PetType] ([PetType]) VALUES (@PetType);\r\nSELECT Id, PetType FR" +
                "OM PetType WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[PetType] SET [PetType] = @PetType WHERE (([Id] = @Original_Id) AND " +
                "([PetType] = @Original_PetType));\r\nSELECT Id, PetType FROM PetType WHERE (Id = @" +
                "Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, PetType FROM dbo.PetType";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_PetType) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string PetType) {
            if ((PetType == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PetType, int Original_Id, string Original_PetType, int Id) {
            if ((PetType == null)) {
                throw new global::System.ArgumentNullException("PetType");
            }
            else {
            ...
            if ((Original_PetType == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_PetType));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PetType, int Original_Id, string Original_PetType) {
            return this.Update(PetType, Original_Id, Original_PetType, Original_Id);
        }
    }
